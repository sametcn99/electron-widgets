<template>
  <div class="relative" @click="isOpen = !isOpen">
    ...
    <div
      v-if="isOpen"
      class="absolute right-0 z-10 w-48 py-2 text-sm bg-gray-300 rounded-lg shadow-xl"
    >
      <button
        class="w-full p-1 text-gray-900 hover:bg-gray-900 hover:text-white"
        @click="makeVisibleAllWidgets"
      >
        Show All Widgets
      </button>
      <button
        class="w-full p-1 text-gray-900 hover:bg-gray-900 hover:text-white"
        @click="makeInvisibleAllWidgets"
      >
        Hide All Widgets
      </button>
      <button
