<template>
  ...
  >
    <Bars4Icon
      class="w-6 h-6 rounded-xl hover:scale-105 hover:cursor-pointer"
    />
    <div
      v-if="isOpen"
      class="absolute right-0 z-10 py-2 text-sm bg-gray-300 rounded-lg shadow-xl w-36"
    >
      <button
        class="w-full p-2 text-gray-900 hover:bg-gray-800 hover:text-white"
      ...
      <button
        class="w-full p-2 text-gray-900 hover:bg-red-800 hover:text-white"
        @click="removeWidget()"
      >
        Remove
      </button>
